...
def about_page():
    ...
    st.write("""
        Want to stay in the loop? Subscribe to our newsletter for the latest updates, health tips, and more! [Subscribe Here](https://example.com/subscribe)  # Replace with a real subscription link
    """)
